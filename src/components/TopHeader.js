...
class TopHeader extends Component{
  ...
  render(props){
    return(<div className="menuHeader">
        ...
        <img id="flagBTN" src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.pixilart.com%2Fimages%2Fart%2Fabce8f219c4ef45.gif&f=1&nofb=1" style={{widht:"50px", height:"50px"}}/>
